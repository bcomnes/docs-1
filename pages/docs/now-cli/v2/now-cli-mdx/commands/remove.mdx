...
export const meta = {
  ...
  lastEdited: '2019-09-04T12:42:35.000Z'
}
...
<Note type="warning">
  This command is for <b>advanced use only</b>. Whilst you are unlikely to need
  to, we recommend using the ZEIT dashboard to remove deployments.
</Note>
